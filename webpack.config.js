...
module.exports = env => {
    ...
    let filename = env.production ? "ninepatch.min.js" : "ninepatch.js";
    ...
    return {
        ...
        module: {
            rules: [
                ...
                {
                    test: env.production /* disable this loader for production builds */ ? /^$/ : /^(.(?!\.test))*\.ts$/,
